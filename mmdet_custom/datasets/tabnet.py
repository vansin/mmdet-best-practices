...
class TableDataset(CustomDataset):
    ...
    def evaluate(
        ...
        if metric == 'mAP':
            ...
            for iou_thr in iou_thrs:
                ...
                mean_ap, eval_detail = eval_map(results,
                                                annotations,
                ...
                eval_results[f'MaxF1Score{int(iou_thr * 100):02d}'] = round(
                    max_f1_score, 5)
                eval_results[f'MaxRecallF{int(iou_thr * 100):02d}'] = round(
                    recall_in_max_f1_score, 5)
                eval_results[f'MaxprecisionF{int(iou_thr * 100):02d}'] = round(
                    precision_in_max_f1_score, 5)
