...
class TableIouDetHead(BaseDenseHead, BBoxTestMixin):
    ...
    def loss(self,
        ...
        mlvl_anchors = self.prior_generator.grid_priors(featmap_sizes,
                                                        device=device)
    ...
    def loss_single(self, pred_map, target_map, neg_map):
        ...
        loss_conf = self.loss_conf(pred_conf,
                                   target_conf,
    ...
    def onnx_export(self, pred_maps, img_metas, with_nms=True):
        ...
        for i in range(self.num_levels):
            ...
            if nms_pre > 0:
                ...
                transformed_inds = (bbox_pred.shape[1] * batch_inds +
                                    topk_inds)
