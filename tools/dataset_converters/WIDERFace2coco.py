...
def dataset_classes():
    return WIDERFaceDataset.CLASSES
...
def main():
    ...
    # 设置所有训练集
    xml_path = ['WIDER_train/WIDER_train_annotations/']
    json_out_path = data_root + 'train.json'
    cvt_annotations(xml_path,
                    json_out_path,
                    data_root=data_root,
                    out_valid_img_dir='data/valid')

    xml_path = ['WIDER_val/WIDER_val_annotations/']
