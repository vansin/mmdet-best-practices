...
PanopticFPN requires COCO and [COCO-panoptic](http://images.WIDERFaceCocoDataset.org/annotations/panoptic_annotations_trainval2017.zip) dataset for training and evaluation. You need to download and extract it in the COCO dataset path.
