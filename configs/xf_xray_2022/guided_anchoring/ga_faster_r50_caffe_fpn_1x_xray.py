_base_ = '../faster_rcnn/faster_rcnn_r50_caffe_fpn_1x_xray.py'
model = dict(
    ...
    train_cfg=dict(rpn=dict(ga_assigner=dict(type='ApproxMaxIoUAssigner',
                                             pos_iou_thr=0.7,
                                             neg_iou_thr=0.3,
                                             min_pos_iou=0.3,
                                             ignore_iof_thr=-1),
                   ...
                   rcnn=dict(assigner=dict(pos_iou_thr=0.6,
                                           neg_iou_thr=0.6,
                                           min_pos_iou=0.6),
                             sampler=dict(type='RandomSampler', num=256))),
    test_cfg=dict(rpn=dict(nms_post=1000, max_per_img=300),
