...
model = dict(
    ...
    train_cfg=dict(rpn=[
        dict(assigner=dict(type='RegionAssigner',
                           center_ratio=0.2,
                           ignore_ratio=0.5),
             allowed_border=-1,
             pos_weight=-1,
        ...
        dict(assigner=dict(type='MaxIoUAssigner',
             ...
             debug=False)
                   ...
                   rcnn=dict(assigner=dict(pos_iou_thr=0.65,
                                           neg_iou_thr=0.65,
                                           min_pos_iou=0.65),
                             sampler=dict(type='RandomSampler', num=256))),
    test_cfg=dict(rpn=dict(max_per_img=300, nms=dict(iou_threshold=0.8)),
