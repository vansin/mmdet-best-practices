...
data = dict(samples_per_gpu=2,
            workers_per_gpu=2,
            train=dict(type='XrayDataset',
                       ann_file='data/xray-2022/train_all.json',
                       img_prefix='data/xray-2022/',
                       pipeline=[
                           dict(type='LoadImageFromFile'),
                           dict(type='LoadAnnotations', with_bbox=True),
                           dict(type='Resize',
            ...
            val=dict(type='XrayDataset',
                     ann_file='data/xray-2022/val.json',
                     img_prefix='data/xray-2022/',
                     pipeline=[
                         dict(type='LoadImageFromFile'),
                         dict(type='MultiScaleFlipAug',
...
work_dir = './work_dirs/xf_xray_2022/faster_rcnn/faster_rcnn_r101_fpn_1x_xray'
auto_resume = False
gpu_ids = [0]
